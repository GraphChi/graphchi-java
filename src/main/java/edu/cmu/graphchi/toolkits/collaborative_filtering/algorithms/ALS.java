...
class ALSParams extends ModelParameters {
	...
	public void serialize(String dir) {
		String paramString = "lambda_"+lambda+"_factor_"+numFactors;
		String filename = dir + "ALS_model_param_"+paramString;
		try{
