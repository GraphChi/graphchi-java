...
public class KCoreDecomposer implements GraphChiProgram<Integer, Integer> {
	...
	public void update(ChiVertex<Integer, Integer> vertex, GraphChiContext context) {
		...
		int iteration = context.getIteration(),
			numOutEdges = vertex.numOutEdges();
		...
		if( iteration == 0 ) {
			...
			SortedMap<Integer, Integer> inEdgeValueCounts = Collections.synchronizedSortedMap(new TreeMap<Integer, Integer>(Collections.reverseOrder()));
    ...
    public static void main(String[] args) throws IOException {
    	 ...
    	 *	java -Xmx2048m -cp bin:gchi-libs/* -Dnum_threads=4  KCoreDecomposition filename nbrOfShards filetype memoryBudget
    	 *
        ...
        TreeSet<IdInt> topToBottom = Toplist.topListInt(inputFilePath, engine.numVertices(), engine.numVertices());
